...
public class WatchDogHandler {
    ...
    public static void resuscitateWatchdog() {
        if (!(MineTogetherServersServer.minecraftServer instanceof DedicatedServer)) return;
        DedicatedServer server = (DedicatedServer) MineTogetherServersServer.minecraftServer;
