 ...
 */
public class MineTogetherServersServer {
    ...
    private static void startServerListThread(MinecraftServer server) {
        ...
        LOGGER.info("Current discoverability: {}", MineTogetherServersServer.discoverability);
        try {
            discoverability = Discoverability.valueOf(MineTogetherServersServer.discoverability.toUpperCase(Locale.ROOT));
        } catch (Throwable ex) {
